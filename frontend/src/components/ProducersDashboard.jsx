      ...
      <div className="flex-1">
        ...
        <div className="border-b border-gray-200 bg-white p-4 shadow-sm">
          <div className="flex space-x-4">
            <button className="text-[#f9960e] hover:text-[#da850d] font-medium">Raw Materials</button>
            <button className="text-gray-600 hover:text-gray-800">Inventory</button>
            <button className="text-gray-600 hover:text-gray-800">Suppliers</button>
          </div>
        </div>
